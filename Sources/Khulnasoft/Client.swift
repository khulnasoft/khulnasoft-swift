...
/// A Khulnasoft HTTP API client.
///
/// See https://khulnasoft.com/docs/reference/http
public class Client {
    ...
    ///
    /// You can get an Khulnasoft API token on your
    /// [account page](https://khulnasoft.com/account).
    ///
    /// - Parameters:
    ///   - session: The underlying client session. Defaults to `URLSession(configuration: .default)`.
    ///   - baseURLString: The base URL for requests made by the client. Defaults to "https://api.khulnasoft.com/v1/".
    ///   - userAgent: The value for the `User-Agent` header sent in requests, if any. Defaults to `nil`.
    ///   - token: The API token.
    public init(
        session: URLSession = URLSession(configuration: .default),
        baseURLString: String = "https://api.khulnasoft.com/v1/",
    ...
    ///        For example, 
    ///        [stability-ai/stable-diffusion-3](https://khulnasoft.com/stability-ai/stable-diffusion-3)
    ...
    ///         the "Versions" tab on the Khulnasoft model page,
    ///         e.g. khulnasoft.com/khulnasoft/hello-world/versions,
    ...
    /// Search for public models on Khulnasoft.
    ///
    /// - Parameters:
    ...
    /// List hardware available for running a model on Khulnasoft.
    ///
    ...
    ///
    ///         See <https://khulnasoft.com/collections>
    ...
    /// Train a model on Khulnasoft.
    ///
    /// To find out which models can be trained,
    /// check out the [trainable language models collection](https://khulnasoft.com/collections/trainable-language-models).
    ///
    /// - Parameters:
    ///    - model:
    ...
    ///          For example, "khulnasoft/my-app-image-generator".
